...
export class QuestionsRepository extends Repository<QuestionsEntity> {
    ...
    async findAll(dto: PaginationRequestDto) {
        ...
        return await query.andWhere('questions.is_approved = :value',{value:true}).take(dto.limit).offset((dto.page - 1) * dto.limit).getManyAndCount()
    }
    ...
    async getOne(id: number) {
        ...
        .andWhere('questions.is_approved = :value',{value:true})
        .getOne()
    }
}
